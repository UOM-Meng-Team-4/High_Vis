    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'hotspot_action.action.Nav_Goal')
            logger.debug(
...
class Nav_Goal(metaclass=Metaclass_Nav_Goal):
    ...
    def __init__(self, **kwargs):
        ...
        self.coordinate_x = kwargs.get('coordinate_x', float())
        self.coordinate_y = kwargs.get('coordinate_y', float())
    ...
    def coordinate_x(self, value):
        if __debug__:
            assert \
                ...
                "The 'coordinate_x' field must be of type 'float'"
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'coordinate_x' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
    ...
    def coordinate_y(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'coordinate_y' field must be of type 'float'"
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'coordinate_y' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
...
class Metaclass_Nav_Result(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'hotspot_action.action.Nav_Result')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Nav_Result(metaclass=Metaclass_Nav_Result):
    ...
    def __init__(self, **kwargs):
        assert all('_' + key in self.__slots__ for key in kwargs.keys()), \
            'Invalid arguments passed to constructor: %s' % \
            ', '.join(sorted(k for k in kwargs.keys() if '_' + k not in self.__slots__))
        self.mp_reached = kwargs.get('mp_reached', bool())
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.mp_reached != other.mp_reached:
            return False
        return True
    ...
    @builtins.property
    def mp_reached(self):
        """Message field 'mp_reached'."""
        return self._mp_reached

    @mp_reached.setter
    def mp_reached(self, value):
        if __debug__:
            assert \
                isinstance(value, bool), \
                "The 'mp_reached' field must be of type 'bool'"
        self._mp_reached = value
...
class Metaclass_Nav_Feedback(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'hotspot_action.action.Nav_Feedback')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Nav_Feedback(metaclass=Metaclass_Nav_Feedback):
    ...
    def __init__(self, **kwargs):
        assert all('_' + key in self.__slots__ for key in kwargs.keys()), \
            'Invalid arguments passed to constructor: %s' % \
            ', '.join(sorted(k for k in kwargs.keys() if '_' + k not in self.__slots__))
        self.time_to_mp = kwargs.get('time_to_mp', int())
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.time_to_mp != other.time_to_mp:
            return False
        return True
    ...
    @builtins.property
    def time_to_mp(self):
        """Message field 'time_to_mp'."""
        return self._time_to_mp

    @time_to_mp.setter
    def time_to_mp(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'time_to_mp' field must be of type 'int'"
            assert value >= -9223372036854775808 and value < 9223372036854775808, \
                "The 'time_to_mp' field must be an integer in [-9223372036854775808, 9223372036854775807]"
        self._time_to_mp = value
...
class Nav_SendGoal_Request(metaclass=Metaclass_Nav_SendGoal_Request):
    ...
    _fields_and_field_types = {
        ...
        'goal': 'hotspot_action/Nav_Goal',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['hotspot_action', 'action'], 'Nav_Goal'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from hotspot_action.action._nav import Nav_Goal
...
class Metaclass_Nav_SendGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'hotspot_action.action.Nav_SendGoal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from hotspot_action.action import _nav
...
class Nav_SendGoal(metaclass=Metaclass_Nav_SendGoal):
    from hotspot_action.action._nav import Nav_SendGoal_Request as Request
    from hotspot_action.action._nav import Nav_SendGoal_Response as Response
...
class Nav_GetResult_Response(metaclass=Metaclass_Nav_GetResult_Response):
    ...
    _fields_and_field_types = {
        'status': 'int8',
        'result': 'hotspot_action/Nav_Result',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('int8'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['hotspot_action', 'action'], 'Nav_Result'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from hotspot_action.action._nav import Nav_Result
...
class Metaclass_Nav_GetResult(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'hotspot_action.action.Nav_GetResult')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Nav_GetResult(metaclass=Metaclass_Nav_GetResult):
    from hotspot_action.action._nav import Nav_GetResult_Request as Request
    from hotspot_action.action._nav import Nav_GetResult_Response as Response
...
class Metaclass_Nav_FeedbackMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'hotspot_action.action.Nav_FeedbackMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Nav_FeedbackMessage(metaclass=Metaclass_Nav_FeedbackMessage):
    ...
    _fields_and_field_types = {
        'goal_id': 'unique_identifier_msgs/UUID',
        'feedback': 'hotspot_action/Nav_Feedback',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['hotspot_action', 'action'], 'Nav_Feedback'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from unique_identifier_msgs.msg import UUID
        self.goal_id = kwargs.get('goal_id', UUID())
        from hotspot_action.action._nav import Nav_Feedback
...
class Nav(metaclass=Metaclass_Nav):
    ...
    from hotspot_action.action._nav import Nav_Goal as Goal
    # The result message defined in the action definition.
    from hotspot_action.action._nav import Nav_Result as Result
    # The feedback message defined in the action definition.
    from hotspot_action.action._nav import Nav_Feedback as Feedback

    class Impl:

        # The send_goal service using a wrapped version of the goal message as a request.
        from hotspot_action.action._nav import Nav_SendGoal as SendGoalService
        # The get_result service using a wrapped version of the result message as a response.
        from hotspot_action.action._nav import Nav_GetResult as GetResultService
        # The feedback message with generic fields which wraps the feedback message.
        from hotspot_action.action._nav import Nav_FeedbackMessage as FeedbackMessage
